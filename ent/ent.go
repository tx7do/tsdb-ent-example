...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		attributekv.Table:    attributekv.ValidColumn,
		sensor.Table:         sensor.ValidColumn,
		sensordata.Table:     sensordata.ValidColumn,
		tskv.Table:           tskv.ValidColumn,
		tskvdictionary.Table: tskvdictionary.ValidColumn,
		tskvlatest.Table:     tskvlatest.ValidColumn,
	}
